...
// const SoloContentIcon = ({ width = 24, height = 24, color = '#AAAAAA', ...props }) => {
//   return (
//     <svg width={width} height={height} viewBox="0 0 22 13" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
//       <path
