...
const DetailPageVerticalReversePlayIcon = ({ width = 28, height = 28, color = '#aaa', ...props }) => {
  return (
...
DetailPageVerticalReversePlayIcon.propTypes = {
  width: PropTypes.number,
  height: PropTypes.number,
  color: PropTypes.string,
};

export default DetailPageVerticalReversePlayIcon;
