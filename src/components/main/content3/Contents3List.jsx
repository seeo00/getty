...
import Contents3Item from './Contents3Item';
    ...
    >
      {dramaData.map((item) => (
        <SwiperSlide key={item.id}>
          <Contents3Item imgurl={`https://image.tmdb.org/t/p/w500${item.poster_path}`} desc={item.overview} />
        </SwiperSlide>
      ))}
    </Swiper>
  );
