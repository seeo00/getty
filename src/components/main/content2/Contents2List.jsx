...
import Contents2Item from './Contents2Item';
    ...
    >
      {dramaData.map((item) => (
        <SwiperSlide key={item.id}>
          <Contents2Item imgurl={`https://image.tmdb.org/t/p/w500${item.poster_path}`} desc={item.overview} />
        </SwiperSlide>
      ))}
    </Swiper>
  );
