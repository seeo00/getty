...
import Contents5Item from './Contents5Item';
    ...
    >
      {dramaData.map((item) => (
        <SwiperSlide key={item.id}>
          <Contents5Item imgurl={`https://image.tmdb.org/t/p/w500${item.poster_path}`} desc={item.overview} />
        </SwiperSlide>
      ))}
    </Swiper>
  );
