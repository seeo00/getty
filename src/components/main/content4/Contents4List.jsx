...
import Contents4Item from './Contents4Item';
    ...
    >
      {dramaData.map((item) => (
        <SwiperSlide key={item.id}>
          <Contents4Item imgurl={`https://image.tmdb.org/t/p/w500${item.poster_path}`} desc={item.overview} />
        </SwiperSlide>
      ))}
    </Swiper>
  );
